...
const jwtTokenMiddleware = require("./middleware/jwtAuth"); // Import JWT middleware
...
mongoose
  .connect(
    "mongodb+srv://mmwrreddy7:reddy1234@cluster0.ti8wiih.mongodb.net/sampleExpress"
  )
  .then(() => {
...
app.post(
  "/send_video_details",
  jwtTokenMiddleware.verifyToken,
  async (req, res) => {
    try {
